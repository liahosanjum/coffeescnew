...
<div class="row profile_inner_co">
    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-12 profile_inner_wrapper_content_co"> 
        <div class="register-page-wrapper page-wrapper">
                ...
                <?php endif; ?> 
               <?php if(isset($loggedUseraddressInfo)): ?> 
                <div class="row co_info_wrapper">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12   ">
                        <div class="title_cartinfo">Name:</div>
                        <div class="cartinfo_detail"> <?php echo e($loggedUseraddressInfo[0]->name); ?></div>
                        <div class="clr"></div>
                    </div>
                </div>
                ...
                <div class="row co_info_wrapper">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12 ">
                        ...
                        <div class="cartinfo_detail"> <?php echo e($loggedUseraddressInfo[0]->address); ?></div>
                        <div class="cartinfo_detail"> <?php echo e($loggedUseraddressInfo[0]->country_name); ?></div>
                        <div class="cartinfo_detail"> <?php echo e($loggedUseraddressInfo[0]->city_name); ?></div>
                        <div class="cartinfo_detail"> <?php echo e($loggedUseraddressInfo[0]->shipping_address); ?></div>
                        <div class="clr"></div>
                    </div>
                </div>
                <div class="row co_info_wrapper">
                    ...
                    <div class="cartinfo_detail"> <?php echo e($loggedUseraddressInfo[0]->mobile); ?></div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\coffeesc\resources\views/checkout/checkoutaddress.blade.php ENDPATH**/ ?>
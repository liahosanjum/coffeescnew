                ...
                <div class="row order-list">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                            <div class="row order-wrapper">
                                ...
                                <div class="col-lg-2">No of Items</div>
                ...
                <div class="row" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 " >
                            <div class="row order-wrapper-list">
                                ...
                                <div class="col-lg-2"><?php echo e($order->username); ?> </div>
                                <div class="col-lg-2"><?php echo e($order->total); ?> </div>
                                ...
                                <div class="col-lg-2"><a href="<?php echo e(route('order.orderdetails', $order->id)); ?>">View Orders</a></div>
                               <div class='clr'></div>
                            </div>
                     </div>
...
<?php echo $__env->make('auth.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\coffeesc\resources\views/auth/admin/order/myorder.blade.php ENDPATH**/ ?>
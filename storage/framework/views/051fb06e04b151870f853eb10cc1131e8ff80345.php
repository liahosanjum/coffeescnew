                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                                <form method="POST" action="<?php echo e(route('assignpermrole.store')); ?>"   id="permroleassignEditForm" name="permroleassignEditForm" >
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control"  id="permission_id" name="permission_id">
                                          <?php $__currentLoopData = $perm_users_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm_user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                            <option   value="<?php echo e($perm_user->id); ?>"><?php echo e($perm_user->key); ?> </option>
...
<?php echo $__env->make('auth.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\coffeesc\resources\views/auth/admin/assignpermrole/create.blade.php ENDPATH**/ ?>
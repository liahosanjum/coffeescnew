 ...
 <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12 col-12 offset-lg-3">
        ...
        <form>
            ...
            <input readonly="readonly" value="<?php echo e($mobile); ?>" type="text" id="number" class="form-control" placeholder="+91 ********">
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\coffeesc\resources\views/user/verifymobile.blade.php ENDPATH**/ ?>
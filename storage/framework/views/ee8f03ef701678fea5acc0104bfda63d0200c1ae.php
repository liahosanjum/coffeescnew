                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <form method="post" action="<?php echo e(route('menu.store')); ?>"   id="menuForm" name="menuForm" >
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control"  id="status" name="status">
                                            ...
                                            <option value="<?php echo e($menu_parent_id->id); ?>"><?php echo e($menu_parent_id->title); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <span style="color:red"> <?php $__errorArgs = ["status"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control" placeholder="Enter title" value="<?php echo e(old('title')); ?>" />
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="form-group">
                                        <label for="">Url</label>
                                        <input type="text" name="url" id="url" class="form-control" placeholder="Enter url" value="<?php echo e(old('url')); ?>" />
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="order" id="order" class="form-control" placeholder="Enter order" value="<?php echo e(old('order')); ?>" />
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="route" id="route" class="form-control" placeholder="Enter route" value="<?php echo e(old('route')); ?>" />
...
<?php echo $__env->make('auth.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\coffeesc\resources\views/auth/admin/menu/create.blade.php ENDPATH**/ ?>
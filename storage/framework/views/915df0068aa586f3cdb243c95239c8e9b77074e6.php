...
<div class="row profile_inner">
    ...
    <div class="col-lg-10 col-md-10 col-sm-12 col-12 profile_inner_wrapper_content"> 
        <div class="register-page-wrapper page-wrapper">
                ...
                <?php if($info_assigned_roles != '' && $info_assigned_roles != null): ?>
                
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                                <form method="POST" action="<?php echo e(route('assignrole.update',$info_assigned_roles[0]->admin_role_id)); ?>"   id="roleassignEditForm" name="roleassignEditForm" >
                                    <?php echo csrf_field(); ?>
                 ...
                 <option <?php if( $info_assigned_roles[0]->id == $admin_user->admin_id ) { echo 'selected=selected'; } ?>  value="<?php echo e($admin_user->id); ?>"><?php echo e($admin_user->name); ?></option>
...
unset($__errorArgs, $__bag); ?></span>
                 ...
                 <option <?php if( $info_assigned_roles[0]->role_id == $inforoles->id ) { echo 'selected=selected'; } ?>  value="<?php echo e($inforoles->id); ?>"><?php echo e($inforoles->name); ?></option>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
<?php echo $__env->make('auth.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\coffeesc\resources\views/auth/admin/assignroles/edit.blade.php ENDPATH**/ ?>
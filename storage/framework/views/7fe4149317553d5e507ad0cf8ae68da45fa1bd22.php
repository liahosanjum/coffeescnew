        ...
        <div class="register-page-wrapper page-wrapper">
                <div class="row prod-heading">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 add-listing">
                        <div class="btn-wrapper"><a class="btn-admin" href="<?php echo e(route('roles.create')); ?>">Add Roles</a></div>
                    </div>
                </div>
                ...
                <?php if($roles_all != null || $roles_all != ""): ?>  
                ...
                <?php $__currentLoopData = $roles_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rolInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row pr-det-wrapper">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 prod-admin-list-roles">
                       <div class="row prod-admin-info_role">
                           <div class="col-lg-2 col-md-3 col-sm-6 col-12"><?php echo e($rolInfo->id); ?></div>
                           <div class="col-lg-4 col-md-3 col-sm-6 col-12"><?php echo e($rolInfo->display_name); ?></div>
                           <div class="col-lg-3 col-md-1 col-sm-6 col-12"><?php echo e($rolInfo->name); ?></div>
                           
                           <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="row prod-detal-link">
                                    <div class="col-lg-4 col-md-2 col-sm-2 col-3">
                                        <a href="<?php echo e(route('roles.edit',$rolInfo->id)); ?>"><i class="fa fa-edit" ></i></a>
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-3">
                                        <span></span>
                                    </div>
                                    <div data-id="<?php echo e($rolInfo->id); ?>" class="adminn-del col-lg-4 col-md-2 col-sm-2 col-3">
                                        <a class="remove-from-role" href="<?php echo e(route('roles.delete',$rolInfo->id)); ?>"><i class="fa fa-trash-o"></i></a>
                                    </div>
...
<?php echo $__env->make('auth.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\coffeesc\resources\views/auth/admin/role/index.blade.php ENDPATH**/ ?>
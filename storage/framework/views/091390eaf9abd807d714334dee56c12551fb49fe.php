        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12 admin-header">
            <div class="top-menu-green">
                <ul class="header-menu nav">
                        ...
                        <?php if(session()->get('adminLoggedUserId')): ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12 logout-section">
            <div class="top-menu-right">
                ...
                <?php if(session()->get('adminLoggedUserId')): ?>
                    ...
                    <li class="nav-item logout"><a class="nav-link top-nav-list" href="<?php echo e(url('/admin/adminlogout')); ?>">Logout</a></li>
                    <li class="nav-item welcomeadmin">|</li>
                    <li class="nopadding"><span><i class="fa-adj  fa fa-user" aria-hidden="true"></i></span></li>
                    <li class="nav-item welcomeadmin"><?php echo e(session()->get('adminLoggedUserName')); ?></li>
                <?php endif; ?>
                </ul>
            </div>
        </div>
...
</style><?php /**PATH D:\xampp\htdocs\coffeesc\resources\views/auth/admin/header/admintopheader.blade.php ENDPATH**/ ?>
            ...
            <div class="register-page-wrapper page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                            ...
                            <form method="post" id="form" name="form" action="{{route('updateShippingAddress')}}">
                            @csrf
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="text" name="address" id="address" class="form-control" placeholder="Enter Address" value="{{ $loggedUserAddress }}" />
                                ...
                                <div class="form-group">Country</label>
                                    ...
                                    <select class="form-control" name="country" id="country">
                                        ...
                                        @foreach($country_list_all as $country)
                                            <option <?php if($loggedUserCountry == $country->id){ echo "selected=selected"; }?> value="{{$country->id}}">{{ $country->country_name }}</option>
                                        @endforeach
                                    </select>

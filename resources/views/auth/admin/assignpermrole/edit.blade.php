...
<div class="row profile_inner">
    ...
    <div class="col-lg-10 col-md-10 col-sm-12 col-12 profile_inner_wrapper_content"> 
        <div class="register-page-wrapper page-wrapper">
                ...
                @if($info_assignedperm_roles != '' && $info_assignedperm_roles != null)
                
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                                <form method="POST" action="{{route('assignpermrole.update',$info_assignedperm_roles[0]->permrole_id)}}"   id="permroleassignEditForm" name="permroleassignEditForm" >
                                    @csrf
                                    {{ method_field('PUT') }}
                 ...
                 <option @php if( $info_assignedperm_roles[0]->id == $perm_user->id ) { echo 'selected=selected'; } @endphp  value="{{$perm_user->id}}">{{$perm_user->key}} </option>
                                             @endforeach
                                        </select>
                 ...
                 <option @php if( $info_assignedperm_roles[0]->role_id == $inforoles->id ) { echo 'selected=selected'; } @endphp  value="{{$inforoles->id}}">{{$inforoles->name}} </option>
                                             @endforeach
                                        </select>
